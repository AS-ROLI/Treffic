...
class single_patient_info_doc extends StatefulWidget {
  static const String id = "single_patient" ;
  @override
...
class _single_patient_info_docState extends State<single_patient_info_doc> {
  ...
  late String name=' ', emt_no=' ', age=' ', gender=' ', gc=' ', bp=' ', pulse=' ', temp=' ', oxy=' ', rbs=' ', lft=' ', rft=' ', cbp=' ', ho=' ';
  ...
  Future get_info1() async{
    final message = await _firestore.collection("Temporary_info").get();
    ...
    final messages = await _firestore.collection("Patient_info").get();
      ...
      actions: [
        ...
        FlatButton(
            ...
            onPressed: () async {
              try {
                final message =
                await _firestore.collection("Patient_info").get();
                for (var messages in message.docs) {
