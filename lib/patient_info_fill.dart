...
class _patient_info_fillState extends State<patient_info_fill> {
  ...
  void getCurrentUser() async {
    try {
      ...
      final message =
      await _firestore.collection("ambulance_location").get();
  ...
  final Patient_Information = <String>[
    'A',
    'B',
    '',
    '',
    ...
    try {
      if (isSwitched == false) {
        ...
        String location_of_user =
            ...
            .subAdministrativeArea}, ${placemark[0].locality}";
        ...
        final message = await _firestore.collection("ambulance_location").get();
        for (var messages in message.docs) {
          if (messages.data()["email"] == loggedInUser.email) {
            _firestore
        ...
        child: ListView(
          ...
          children: <Widget>[
            UserAccountsDrawerHeader(
              ...
              accountEmail: Text(
                  email_of_user, style: TextStyle(fontSize: 20.0)),
            ...
            Padding(
              ...
              child: Text(
                  "Notify Traffic police that you are stuck in traffic - ",
                  style: TextStyle(
                    fontSize: 15.0,
            ...
            Padding(
              ...
              child: Text(
                  "Note : Don't forget to turn it back to green when free from traffic.",
                  style: TextStyle(
                    fontSize: 15.0,
                    //fontWeight: FontWeight.bold,
                  )
        ...
        child: Container(
          ...
          child: Column(children: [
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                  ...
                  focusedBorder: OutlineInputBorder(
                      ...
                      borderRadius: BorderRadius.circular(5.0))),
              onChanged: (value) {
                Patient_Information[0] = value.toString();
              },
            ),
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                  ...
                  focusedBorder: OutlineInputBorder(
                      ...
                      borderRadius: BorderRadius.circular(5.0))),
              onChanged: (value) {
                Patient_Information[1] = value.toString();
              },
            ),
            SizedBox(
              height: 30.0,
                ...
                child: Radio(
                  ...
                  onChanged: (value) {
                    setState(() {
                      ...
                      Patient_Information[3] = value.toString();
                    });
                  },
                ),
              ),
            ...
            TextFormField(
              ...
              onChanged: (value) {
                Patient_Information[4] = value.toString();
              },
            ),
            SizedBox(
              height: 30.0,
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                  ...
                  focusedBorder: OutlineInputBorder(
                      ...
                      borderRadius: BorderRadius.circular(10.0))),
              onChanged: (value) {
                Patient_Information[5] = value.toString();
              },
            ),
            SizedBox(
              height: 30.0,
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                  ...
                  focusedBorder: OutlineInputBorder(
                      ...
                      borderRadius: BorderRadius.circular(10.0))),
              onChanged: (value) {
                Patient_Information[6] = value.toString();
              },
            ),
            SizedBox(
              height: 30.0,
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                  ...
                  focusedBorder: OutlineInputBorder(
                      ...
                      borderRadius: BorderRadius.circular(10.0))),
              onChanged: (value) {
                Patient_Information[7] = value.toString();
              },
            ),
            SizedBox(
              height: 30.0,
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                  ...
                  focusedBorder: OutlineInputBorder(
                      ...
                      borderRadius: BorderRadius.circular(10.0))),
              onChanged: (value) {
                Patient_Information[8] = value.toString();
              },
            ),
            SizedBox(
              height: 30.0,
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                  ...
                  focusedBorder: OutlineInputBorder(
                      ...
                      borderRadius: BorderRadius.circular(10.0))),
              onChanged: (value) {
                Patient_Information[9] = value.toString();
              },
            ),
            SizedBox(
              height: 30.0,
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                  ...
                  focusedBorder: OutlineInputBorder(
                      ...
                      borderRadius: BorderRadius.circular(10.0))),
              onChanged: (value) {
                Patient_Information[10] = value.toString();
              },
            ),
            SizedBox(height: 10.0),
            Text(
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                  ...
                  focusedBorder: OutlineInputBorder(
                      ...
                      borderRadius: BorderRadius.circular(10.0))),
              onChanged: (value) {
                Patient_Information[11] = value.toString();
              },
            ),
            SizedBox(height: 10.0),
            Text(
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                  ...
                  focusedBorder: OutlineInputBorder(
                      ...
                      borderRadius: BorderRadius.circular(10.0))),
              onChanged: (value) {
                Patient_Information[12] = value.toString();
              },
            ),
            SizedBox(height: 10.0),
            Text(
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                  ...
                  focusedBorder: OutlineInputBorder(
                      ...
                      borderRadius: BorderRadius.circular(10.0))),
              onChanged: (value) {
                Patient_Information[13] = value.toString();
              },
            ),
            SizedBox(
              height: 30.0,
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                  ...
                  focusedBorder: OutlineInputBorder(
                      ...
                      borderRadius: BorderRadius.circular(10.0))),
              onChanged: (value) {
                Patient_Information[14] = value.toString();
              },
            ),
